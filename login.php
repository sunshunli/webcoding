...
<div id="login">
    ...
    <form method="post" name="login" action="login.php?action=login">
        <dl>
            ...
            <dd>保      留：<input type="radio" name="time" value="0" checked="checked">不保留<input type="radio" name="time" value="1">保留一天<input type="radio" name="time" value="2">保留一周<input type="radio" name="time" value="3">保留一个月</dd>
